...
test("sourceRangeCards: full chunks plus remainder", () => {
  assert.deepEqual(sourceRangeCards(156, 25), [
    { offset: 0, start: 1, end: 25, count: 25 },
    { offset: 25, start: 26, end: 50, count: 25 },
    { offset: 50, start: 51, end: 75, count: 25 },
    { offset: 75, start: 76, end: 100, count: 25 },
    { offset: 100, start: 101, end: 125, count: 25 },
    { offset: 125, start: 126, end: 150, count: 25 },
    { offset: 150, start: 151, end: 156, count: 6 },
  ])
  assert.deepEqual(sourceRangeCards(28, 25), [
    { offset: 0, start: 1, end: 25, count: 25 },
    { offset: 25, start: 26, end: 28, count: 3 },
  ])
  assert.deepEqual(sourceRangeCards(164, 25).at(-1), {
    offset: 150,
    start: 151,
    end: 164,
    count: 14,
