...
export function MockExamStatusBar({
  ...
  return (
    <div className="flex items-stretch">
      <div data-tutorial="question-number" className="flex min-w-[110px] flex-col items-center justify-center gap-0.5 bg-neutral-200 px-4 py-2">
      ...
      <div data-tutorial="timer" className="flex flex-1 flex-col items-center justify-center gap-0.5 bg-neutral-200 px-4 py-2">
      ...
      <div data-tutorial="answered" className="flex min-w-[130px] flex-col items-center justify-center gap-0.5 bg-red-600 px-4 py-2 text-white">
      ...
      <div data-tutorial="unanswered" className="flex min-w-[150px] flex-col items-center justify-center gap-0.5 bg-red-600 px-4 py-2 text-white">
        <span className="text-center text-xs opacity-90">
