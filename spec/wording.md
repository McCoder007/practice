  ...
  switch (rule) {
    ...
    case 2:
      ...
      if (baseForm.length >= 2) {
        wrongAnswers.push(baseForm.slice(0, -1) + baseForm[baseForm.length - 2] + 'ing');
      }
      break;

    case 3:
      wrongAnswers.push(baseForm + 'ing');
      wrongAnswers.push(baseForm + baseForm[baseForm.length - 1] + baseForm[baseForm.length - 1] + 'ing');
      break;
