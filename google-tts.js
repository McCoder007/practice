...
class GoogleTTSManager {
    ...
    setApiKey(key) {
        ...
        this.apiKey = key;
        console.log('[google-tts] Google TTS API key set internally.'); // Keep original log for reference
    ...
    async synthesizeSpeech(text, isPreInit = false) {
        // DEBUG: Log when synthesis is attempted and the current state of this.apiKey
